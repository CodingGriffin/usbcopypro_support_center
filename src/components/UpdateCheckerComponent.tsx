...
const UpdateCheckerComponent: React.FC = () => {
  ...
  const {
    ...
    if (updatable.data !== undefined) {
      // Check if data is an array with items or a truthy value
      const hasUpdates = Array.isArray(updatable.data)
        ? updatable.data.length > 0
        : !!updatable.data;
						...
						<div className="space-y-4">
							...
							<div className="flex items-start space-x-3">
								...
								<label htmlFor="diagnostics" className="text-sm text-gray-700 dark:text-gray-300">
									Include diagnostics information to help improve the software
								</label>
							</div>
